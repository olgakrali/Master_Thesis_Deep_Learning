...
dataroot2='../augmented_train_masks/'

dataroot3='../augmented_val_masks/'
dataroot4='../augmented_test_masks/'
...
path= '../saved_models/model-DCGAN-BC-AdversarialEncDec-patch-MaskInfilling-BCMasks-2chan-Box-Mask-256/'
