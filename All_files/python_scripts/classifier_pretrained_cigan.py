...
# 
# # Real & Class Conditional GAN Augmented data
...
dataroot7 = 'notneeded'   
dataroot8 = '../cigan_images/' # cigan augmented images
...
for epoch in range(num_epochs):  
        ...
        with torch.no_grad():
            for j, data in enumerate(val_loader,0):
                ...
                # Save the model
                    torch.save(model.state_dict(), path + 'bestci.pth') 
