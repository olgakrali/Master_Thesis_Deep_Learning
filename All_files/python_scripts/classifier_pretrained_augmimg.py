...
#  Training on real & Traditionally augmented data
# 
...
dataroot6 = '../augm_val_bc/'  # 12260-3760 images
dataroot7 = '../augm_test_bc/' # 11771 -3760 images
dataroot8 = '../augm_train_bc/' # 94327 -3760
...
class DDSM(torch.utils.data.Dataset):             # Notice that masks are in PNG form and mammograms in JPG
    def __init__(self, root1, root2, root3,  labelr, split, transform, transform2, mode):
       ...
       #bc_images
        ...
        if mode == 'train':
            ...
            img_list = imagedir[:500] + auglist[:10000] # real bc & augmented set
        elif mode == 'val':
    ...
    def __getitem__(self, idx):
        ...
        elif 'bc_images_original' in image_name:
...
for epoch in range(num_epochs):  
        ...
        with torch.no_grad():
            for j, data in enumerate(val_loader,0):
                ...
                # Save the model
                    torch.save(model.state_dict(), path + 'bestaugm.pth') 
