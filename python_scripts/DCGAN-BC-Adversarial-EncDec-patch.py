...
plt.legend()
#plt.show()
fig.savefig('Losses-patch-AE.png')
...
vutils.save_image(real_batch[0].to(device)[:64], 'RealPatch-AE.png', padding=2, normalize=True)


# In[ ]:


vutils.save_image(img_list[-1], 'FakePatch-AE.png')

path= '../saved_models/model-DCGAN-BC-Adversarial-EncDec-patch/'
